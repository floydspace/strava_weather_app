[![Quality&Tests](https://github.com/floydspace/strava_weather_app/actions/workflows/python-app.yml/badge.svg)](https://github.com/floydspace/strava_weather_app/actions/workflows/python-app.yml)
